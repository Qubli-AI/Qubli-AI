  ...
  try {
    ...
    const htmlContent = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 0 auto; color: #1a202c; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <div style="background-color: ${feedbackType === "good" ? "#ebf8ff" : "#fff5f5"}; padding: 24px; border-bottom: 4px solid ${feedbackType === "good" ? "#3182ce" : "#e53e3e"};">
          <h2 style="margin: 0; font-size: 24px; color: ${feedbackType === "good" ? "#2b6cb0" : "#c53030"}; text-transform: capitalize;">
